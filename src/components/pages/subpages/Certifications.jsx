...
export default function Certifications({ onReturn }) {
  useEffect(() => {
  ...
  return (
    <div className="subpage-container" role="main" aria-label="Certifications page">
      {/* Top Header */}
      <header className="subpage-header">
        <div className="subpage-brand">
          <span className="subpage-logo">Zeeshaan</span>
          <span className="subpage-category-tag">WORKS // 03</span>
        </div>
      ...
      <main className="subpage-main">
        ...
        <div className="subpage-subtitle">CREDENTIALS // INDUSTRY ACCREDITATIONS</div>
      </main>
